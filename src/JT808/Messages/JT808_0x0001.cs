...
{
    /// <summary>
    /// 0x0001 Terminal general response (终端通用应答)
    /// </summary>
    public class JT808_0x0001 : IJT808MessageBody
    {
        public JT808MsgId MsgId => JT808MsgId.TerminalGeneralResponse;
        ...
        /// <summary>Result (结果): 0=success, 1=failure, 2=message error, 3=unsupported</summary>
        ...
        public static JT808_0x0001 Decode(byte[] body)
        {
            if (body.Length < 5)
                throw new ArgumentException("Body too short for 0x0001", nameof(body));
            return new JT808_0x0001
            {
